...
#endif //P_GIGANTAMAX_FORMS
PLACEHOLDER_ANIM_SINGLE_FRAME(Raichu);
#if P_ALOLAN_FORMS
...
#if P_FAMILY_GEODUDE
PLACEHOLDER_ANIM_SINGLE_FRAME(Geodude);
PLACEHOLDER_ANIM_SINGLE_FRAME(Graveler);
PLACEHOLDER_ANIM_SINGLE_FRAME(Golem);
#if P_ALOLAN_FORMS
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Farfetchd);
...
#endif //P_GEN_4_CROSS_EVOS
PLACEHOLDER_ANIM_SINGLE_FRAME(MrMime);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Qwilfish);
...
#if P_FAMILY_CORSOLA
PLACEHOLDER_ANIM_SINGLE_FRAME(Corsola);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Zigzagoon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Linoone);
